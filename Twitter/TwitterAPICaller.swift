...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "2NpYDnQ1GzFOieavFBlTQ8aik", consumerSecret: "1aZKsrEqSNwbV7pbNYbb5Nq3h6n1eQkjmFNP9PPam2MmujtHFl")
    var loginSuccess: (() -> ())?
